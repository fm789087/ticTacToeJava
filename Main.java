...
//Class Main fir Minigame 4 
class Main {

  File fileMusic = new File(" "); //create sound effects 
  ...
  public static void main(String[] args) {
    playGame(); 
    System.out.println(ANSI_YELLOW+"\nNow getting the CPUs to play against each other! "+ANSI_RESET); 
  }
  ...
  static String[][] loadFileData(String ticTacToeBoard)
  {
    ...
    try{
      ...
      br =new BufferedReader(new FileReader("ticTacToeBoard.txt")); //open buffered reader 
      lineCount=0;
      do{
        line=br.readLine();
        if(line!=null)
  ...
  public static void playGame()
  {
   //initialize variables 
    ...
    String[][] ticTacToeBoard = loadFileData("ticTacToeBoard.txt"); 
    ...
    while(player1Win!=true && player2Win!=true)
    {
      do{
          ...
          System.out.println(ANSI_PURPLE + "\nWhat is the x-coord you'd like to place your flower 🌸?"+ANSI_RESET); 
          yCoord = Integer.parseInt(scan.nextLine());
          System.out.println(ANSI_PURPLE + "What is the y-coord you'd like to place your flower 🌸?"+ANSI_RESET); 
